...
| 增强 A | 知识库分类（category）+ 图谱/导图按分类筛选 + EntitySource 来源映射 | ✅ 完成 |
| 增强 B | 错题间隔重复（Anki 式）：schedule/confirm 多轮确认才真正掌握，练习答对自动推进 | ✅ 完成 |
...
| Phase 3 | 知识库模块：上传、PDF 解析、切片、向量存储 | ✅ 完成 |
| Phase 4 | RAG 系统：Embedding、检索、问答接口 | ✅ 完成 |
| Phase 5 | 知识图谱：实体/关系抽取、可视化、展示 | ✅ 完成 |
| Phase 6 | 前端展示：知识库/问答/图谱/导图页 | ✅ 完成 |
| Phase 7 | AI 出题：生成题目、解析 | ✅ 完成 |
| Phase 8 | 错题系统：保存、分析、建议 | ✅ 完成 |
| 增强 A | 知识库分类 + 图谱/导图按分类筛选 | ✅ 完成 |
| 增强 B | 错题间隔重复掌握判定 | ✅ 完成 |
