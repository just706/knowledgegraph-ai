...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'chat', name: 'chat', component: () => import('@/pages/ChatPage.vue'), meta: { title: 'AI 助手' } },
      ...
      { path: 'quiz', name: 'quiz', component: () => import('@/pages/QuizPage.vue'), meta: { title: '练习' } },
...
const router = createRouter({
  // GitHub Pages 子路径部署使用 hash 模式，避免刷新子路由 404（无需 404.html hack）。
  // 本地开发与其他平台仍可正常工作。
